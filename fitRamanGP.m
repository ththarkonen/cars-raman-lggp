...
for ii = 1:nFiles
    ...
    data_ii.background = 0.2 * data_ii.background / max(  data_ii.background );
    
    minY = min(data_ii.background);
    maxY = max(data_ii.background);
    ...
    dataGP_ii.R = R_ii;
    dataGP_ii.f = data_ii.background + noise_ii;
...
save("./models/bg/bgRaman.mat", "theta");
